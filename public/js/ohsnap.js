...
function ohSnap(text, options) {
  ...
  var $container = $('#'+options['container-id']),
    ...
    // Generate the HTML
    var html = $('<div class="alert ' + color_markup + '">' + ' <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span></button>' + icon_markup + text + '</div>').fadeIn(options['fade-duration']);
